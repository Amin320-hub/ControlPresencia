...
// Pantalla que muestra el resumen de horas trabajadas, teóricas y extra de un mes concreto
// Introduzco el mes (YYYY-MM) y consulto la API
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            String texto = "📅 Mes: " + resumen.mes + "\n\n" +
                                    ...
                                    (resumen.horas_extra >= 0
                                            ...
                                            : "⚠️ Horas pendientes: " + String.format("%.1f", resumen.horas_extra)
                                                    + "h");
