...
// Pantalla de fichaje por NFC
// Cuando acerco el teléfono a la etiqueta NFC, lanzo automáticamente el fichaje
// Tiene las mismas reglas que el fichaje por GPS: no puedo entrar dos veces sin salir
public class FichajeNFCActivity extends AppCompatActivity {
    ...
    // Cuando la Activity pierde el foco, desactivo el modo foreground para no
    // interferir con otras apps
    @Override
    ...
    // Lo llamo cuando detecto una etiqueta NFC mientras esta Activity está en
    // primer plano
    @Override
    protected void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(action) ||
            ...
            // Detecto un tag NFC — obtengo el Tag para verificar que es válido
