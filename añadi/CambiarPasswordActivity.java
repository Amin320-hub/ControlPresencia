...
// Activity para solicitar el cambio de contraseña por email
// El usuario introduce su email y el servidor le manda un enlace para cambiarla desde la web
public class CambiarPasswordActivity extends AppCompatActivity {
    ...
    private void solicitarCambio(String email) {
        ...
        // Este endpoint no requiere autenticación JWT porque el usuario puede no estar logueado
